...
- `npm run dev:full` - Start both frontend and PHP API server automatically
...
- Custom hooks: `useTexts.tsx`, `useProducts.tsx`, `useCategories.tsx`, `useBrands.tsx`
